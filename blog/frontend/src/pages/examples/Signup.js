        ...
        <Container>
          <Row className="justify-content-center form-bg-image" style={{ backgroundImage: `url(${BgImage})` }}>
            <Col xs={12} className="d-flex align-items-center justify-content-center">
              <div className="mb-4 mb-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500" style={{ height: '500px', overflowY: 'auto' }}>

                <div className="text-center text-md-center mb-4 mt-md-0">
                  <h3 className="mb-0">Create an account</h3>
                </div>
                <Form onSubmit={handleSubmit} className="mt-4" method="POST">
                  ...
                  <Form.Group id="lastname" className="mb-4">
                    ...
                    <InputGroup>
                      ...
                      <Form.Control required name="lastname" type="text" placeholder="Doe" />
                    </InputGroup>
                  </Form.Group>
                  ...
                  <Form.Group id="email" className="mb-4">
                    ...
                    <InputGroup>
                      ...
                      <Form.Control required name="email" type="email" placeholder="example@company.com" />
                    </InputGroup>
                  </Form.Group>
                  ...
                  <Form.Group id="repassword" className="mb-4">
